            ...
            <div class="row gx-60">
                <div class="col-lg-6">
                    <div class="product-big-img">
                        <div class="img"><img src="{{ asset('assets/img/product/product_details_1_1.png') }}"
                                alt="Product Image">
                        </div>
                    </div>
                </div>
            ...
            <div class="widget woocommerce widget_shopping_cart">
                ...
                <div class="widget_shopping_cart_content">
                    ...
                    <p class="woocommerce-mini-cart__buttons buttons">
                        <a href="#" class="th-btn wc-forward">View cart <span class="icon"><i
                                    class="fa-solid fa-arrow-up-right ms-3"></i></span></a>
                        <a href="#" class="th-btn checkout wc-forward">Checkout <span class="icon"><i
                                    class="fa-solid fa-arrow-up-right ms-3"></i></span></a>
                    </p>
                </div>
            </div>
                ...
                <div class="th-widget-about">
                    <div class="about-logo">
                        <a href="#">
                            ...
                            <img src="{{ asset('assets/img/xxx.png') }}" alt="Bame">
                        </a>
                    </div>
    ...
    <section class="space bg-top-center" data-bg-src="assets/img/bg/tournament-sec1-bg.png">
        <div class="container">
            <div class="row justify-content-between">
                ...
                <div class="col-lg-auto">
                    <div class="sec-btn custom-anim-right wow animated" data-wow-duration="1.5s"
                        data-wow-delay="0.2s">
